...
class TranslationResult:
	...
	def as_json (self, **kwargs) -> str:
		return dumps({
			...
			"sourceLanguage": str((
				self.source_language.id) if isinstance(self.source_language, Language) else self.source_language),
			"destinationLanguage": str((
				self.destination_language.id) if isinstance(self.destination_language, Language) else self.destination_language),
