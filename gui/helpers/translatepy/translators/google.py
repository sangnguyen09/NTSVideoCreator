...
from gui.helpers.translatepy.exceptions import ServiceURLError, UnsupportedMethod
...
from gui.helpers.translatepy.utils.utils import convert_to_float
...
class GoogleTranslateV2(BaseTranslator):
    ...
    def __init__(self, manage_thread_pool,request: Request = Request(), service_url: str = "translate.google.com", file_json=''):
