...
from gui.helpers.constants import STOP_THREAD_TRANSLATE
...
class Tse:
	...
	def check_en_lang (self, from_lang: str, to_lang: str, default_translator: Optional[
		str] = None, default_lang: str = 'en-US') -> Tuple[str, str]:
...
class GoogleV1(Tse):
	...
	@Tse.time_stat
	@Tse.check_query
	def google_api (self, query_text: str, from_language: str = 'auto', to_language: str = 'en', **kwargs: ApiKwargsType) -> \
			Union[str, dict]:
		"""
...
class BaiduV1(Tse):
	...
	@Tse.debug_language_map
	def get_language_map (self, lang_url: str, ss: SessionType, headers: dict, timeout: Optional[float], proxies:
	Optional[dict], **kwargs: LangMapKwargsType) -> dict:
	...
	@Tse.time_stat
	@Tse.check_query
	def baidu_api (self, query_text: str, from_language: str = 'auto', to_language: str = 'en', **kwargs: ApiKwargsType) -> \
			Union[str, dict]:
		"""
...
class YoudaoV1(Tse):
	...
	@Tse.time_stat
	@Tse.check_query
	def youdao_api (self, query_text: str, from_language: str = 'auto', to_language: str = 'en', **kwargs: ApiKwargsType) -> \
			Union[str, dict]:
		"""
...
class QQFanyi(Tse):
	...
	@Tse.debug_language_map
	def get_language_map (self, ss: SessionType, language_url: str, timeout: Optional[float], proxies: Optional[
		dict], **kwargs: LangMapKwargsType) -> dict:
	...
	@Tse.time_stat
	@Tse.check_query
	def qqFanyi_api (self, query_text: str, from_language: str = 'auto', to_language: str = 'en', **kwargs: ApiKwargsType) -> \
			Union[str, dict]:
		"""
        https://fanyi.qq.com
        :param query_text: str, must.
...
class QQTranSmart(Tse):
	...
	@Tse.debug_language_map
	def get_language_map (self, lang_url: str, ss: SessionType, timeout: Optional[float], proxies: Optional[
		dict], **kwargs: LangMapKwargsType) -> dict:
	...
	@Tse.time_stat
	@Tse.check_query
	def qqTranSmart_api (self, query_text: str, from_language: str = 'auto', to_language: str = 'en', **kwargs: ApiKwargsType) -> \
			Union[str, dict]:
		"""
...
class AlibabaV1(Tse):
	...
	@Tse.debug_language_map
	def get_language_map (self, ss: SessionType, lang_url: str, use_domain: str, dmtrack_pageid: str, timeout: Optional[
		float], proxies: Optional[dict], **kwargs: LangMapKwargsType) -> dict:
	...
	@Tse.time_stat
	@Tse.check_query
	def alibaba_api (self, query_text: str, from_language: str = 'auto', to_language: str = 'en', **kwargs: ApiKwargsType) -> \
			Union[str, dict]:
		"""
...
class Bing(Tse):
	...
	@Tse.time_stat
	@Tse.check_query
	def bing_api (self, query_text: str, from_language: str = 'auto', to_language: str = 'en', **kwargs: ApiKwargsType) -> \
			Union[str, dict]:
		"""
...
class Sogou(Tse):
	...
	@Tse.debug_language_map
	def get_language_map (self, host_html: str, lang_old_url: str, ss: SessionType, timeout: Optional[float], proxies:
	Optional[dict], **kwargs: LangMapKwargsType) -> dict:
		try:
	...
	@Tse.time_stat
	@Tse.check_query
	def sogou_api (self, query_text: str, from_language: str = 'auto', to_language: str = 'en', **kwargs: ApiKwargsType) -> \
			Union[str, dict]:
		"""
...
class Caiyun(Tse):
	...
	@Tse.time_stat
	@Tse.check_query
	def caiyun_api (self, query_text: str, from_language: str = 'auto', to_language: str = 'en', **kwargs: ApiKwargsType) -> \
			Union[str, dict]:
		"""
...
class Deepl(Tse):
	...
	@Tse.time_stat
	@Tse.check_query
	def deepl_api (self, query_text: str, from_language: str = 'auto', to_language: str = 'en', **kwargs: ApiKwargsType) -> \
			Union[str, dict]:
		"""
        https://www.deepl.com
        :param query_text: str, must.
...
class Yandex(Tse):
	...
	@Tse.time_stat
	@Tse.check_query
	def yandex_api (self, query_text: str, from_language: str = 'auto', to_language: str = 'en', **kwargs: ApiKwargsType) -> \
			Union[str, dict]:
		"""
...
class Argos(Tse):
	...
	def get_secret (self, secret_url: str, ss: SessionType, headers: dict, timeout: Optional[float], proxies: Optional[
		dict]) -> str:
	...
	@Tse.time_stat
	@Tse.check_query
	def argos_api (self, query_text: str, from_language: str = 'auto', to_language: str = 'en', **kwargs: ApiKwargsType) -> \
			Union[str, dict]:
		"""
		...
		not_update_cond_time = 1 if time.time() - self.begin_time < update_session_after_seconds else 0
		if not (
				self.session and self.language_map and not_update_cond_freq and not_update_cond_time and self.api_secret):
			self.begin_time = time.time()
			self.session = requests.Session()
			_ = self.session.get(self.host_url, headers=self.host_headers, timeout=timeout, proxies=proxies)
...
class Iciba(Tse):
	...
	@Tse.debug_language_map
	def get_language_map (self, api_url: str, ss: SessionType, headers: dict, timeout: Optional[float], proxies:
	Optional[dict], **kwargs: LangMapKwargsType) -> dict:
	...
	@Tse.time_stat
	@Tse.check_query
	def iciba_api (self, query_text: str, from_language: str = 'auto', to_language: str = 'en', **kwargs: ApiKwargsType) -> \
			Union[str, dict]:
		"""
...
class IflytekV1(Tse):
	...
	@Tse.debug_language_map
	def get_language_map (self, host_html: str, ss: SessionType, headers: dict, timeout: Optional[float], proxies:
	Optional[dict], **kwargs: LangMapKwargsType) -> dict:
		try:
	...
	@Tse.time_stat
	@Tse.check_query
	def iflytek_api (self, query_text: str, from_language: str = 'auto', to_language: str = 'en', **kwargs: ApiKwargsType) -> \
			Union[str, dict]:
		"""
...
class Iflyrec(Tse):
	...
	@Tse.time_stat
	@Tse.check_query
	def iflyrec_api (self, query_text: str, from_language: str = 'auto', to_language: str = 'en', **kwargs: ApiKwargsType) -> \
			Union[str, dict]:
		"""
...
class Reverso(Tse):
	...
	@Tse.time_stat
	@Tse.check_query
	def reverso_api (self, query_text: str, from_language: str = 'auto', to_language: str = 'en', **kwargs: ApiKwargsType) -> \
			Union[str, dict]:
		"""
...
class Itranslate(Tse):
	...
	@Tse.time_stat
	@Tse.check_query
	def itranslate_api (self, query_text: str, from_language: str = 'auto', to_language: str = 'en', **kwargs: ApiKwargsType) -> \
			Union[str, dict]:
		"""
...
class TranslateCom(Tse):
	...
	@Tse.time_stat
	@Tse.check_query
	def translateCom_api (self, query_text: str, from_language: str = 'auto', to_language: str = 'en', **kwargs: ApiKwargsType) -> \
			Union[str, dict]:
		"""
...
class Utibet(Tse):
	...
	@Tse.time_stat
	@Tse.check_query
	def utibet_api (self, query_text: str, from_language: str = 'auto', to_language: str = 'ti', **kwargs: ApiKwargsType) -> \
			Union[str, dict]:
		"""
...
class Papago(Tse):
	...
	@Tse.time_stat
	@Tse.check_query
	def papago_api (self, query_text: str, from_language: str = 'auto', to_language: str = 'en', **kwargs: ApiKwargsType) -> \
			Union[str, dict]:
		"""
...
class Lingvanex(Tse):
	...
	@Tse.time_stat
	@Tse.check_query
	def lingvanex_api (self, query_text: str, from_language: str = 'auto', to_language: str = 'en', **kwargs: ApiKwargsType) -> \
			Union[str, dict]:
		"""
...
class NiutransV1(Tse):
	...
	@Tse.time_stat
	@Tse.check_query
	def niutrans_api (self, query_text: str, from_language: str = 'auto', to_language: str = 'en', **kwargs: ApiKwargsType) -> \
			Union[str, dict]:
		"""
...
class NiutransV2(Tse):
	...
	def get_captcha_id (self, captcha_url: str, ss: SessionType, headers: dict, timeout: Optional[float], proxies:
	Optional[dict]):
...
class Mglip(Tse):
	...
	@Tse.time_stat
	@Tse.check_query
	def mglip_api (self, query_text: str, from_language: str = 'auto', to_language: str = 'mon', **kwargs: ApiKwargsType) -> \
			Union[str, dict]:
		"""
...
class VolcEngine(Tse):
	...
	@Tse.time_stat
	@Tse.check_query
	def volcEngine_api (self, query_text: str, from_language: str = 'auto', to_language: str = 'en', **kwargs: ApiKwargsType) -> \
			Union[str, dict]:
		"""
...
class ModernMt(Tse):
	...
	@Tse.time_stat
	@Tse.check_query
	def modernMt_api (self, query_text: str, from_language: str = 'auto', to_language: str = 'en', **kwargs: ApiKwargsType) -> \
			Union[str, dict]:
		"""
...
class MyMemory(Tse):
	...
	@Tse.time_stat
	@Tse.check_query
	def myMemory_api (self, query_text: str, from_language: str = 'auto', to_language: str = 'en', **kwargs: ApiKwargsType) -> \
			Union[str, dict]:
		"""
...
class Mirai(Tse):
	...
	@Tse.time_stat
	@Tse.check_query
	def mirai_api (self, query_text: str, from_language: str = 'auto', to_language: str = 'ja', **kwargs: ApiKwargsType) -> \
			Union[str, dict]:
		"""
...
class Apertium(Tse):
	...
	@Tse.time_stat
	@Tse.check_query
	def apertium_api (self, query_text: str, from_language: str = 'auto', to_language: str = 'en', **kwargs: ApiKwargsType) -> \
			Union[str, dict]:
		"""
...
class Tilde(Tse):
	...
	@Tse.time_stat
	@Tse.check_query
	def tilde_api (self, query_text: str, from_language: str = 'auto', to_language: str = 'en', **kwargs: ApiKwargsType) -> \
			Union[str, dict]:
		"""
...
class cloudTranslationV1(Tse):
	...
	@Tse.time_stat
	@Tse.check_query
	def cloudTranslation_api (self, query_text: str, from_language: str = 'auto', to_language: str = 'en', **kwargs: ApiKwargsType) -> \
			Union[str, dict]:
		"""
...
class SysTran(Tse):
	...
	@Tse.time_stat
	@Tse.check_query
	def sysTran_api (self, query_text: str, from_language: str = 'auto', to_language: str = 'en', **kwargs: ApiKwargsType) -> \
			Union[str, dict]:
		"""
...
class TranslateMe(Tse):
	...
	# @Tse.time_stat
	# @Tse.check_query
	def _translateMe_api (self, query_text: str, from_language: str = 'auto', to_language: str = 'en', **kwargs: ApiKwargsType) -> \
			Union[str, dict]:
		"""
	...
	@Tse.time_stat
	@Tse.check_query
	def translateMe_api (self, query_text: str, from_language: str = 'auto', to_language: str = 'en', **kwargs: ApiKwargsType) -> \
			Union[str, dict]:
		"""
        https://translateme.network/
        :param query_text: str, must.
...
class Elia(Tse):
	...
	@Tse.time_stat
	@Tse.check_query
	def elia_api (self, query_text: str, from_language: str = 'auto', to_language: str = 'en', **kwargs: ApiKwargsType) -> \
			Union[str, dict]:
		"""
...
class LanguageWire(Tse):
	...
	@Tse.time_stat
	@Tse.check_query
	def languageWire_api (self, query_text: str, from_language: str = 'auto', to_language: str = 'en', **kwargs: ApiKwargsType) -> \
			Union[str, dict]:
		"""
...
class Judic(Tse):
	...
	@Tse.time_stat
	@Tse.check_query
	def judic_api (self, query_text: str, from_language: str = 'auto', to_language: str = 'en', **kwargs: ApiKwargsType) -> \
			Union[str, dict]:
		"""
...
class Yeekit(Tse):
	...
	@Tse.time_stat
	@Tse.check_query
	def yeekit_api (self, query_text: str, from_language: str = 'auto', to_language: str = 'en', **kwargs: ApiKwargsType) -> \
			Union[str, dict]:
		"""
...
class TranslatorsServer:
	def __init__ (self, manage_thread_pool, translate_cache):
		self.translate_cache = translate_cache
		...
		self._baidu = BaiduV2()  # V2
		self._baidu_v1 = BaiduV1()  # V2
		self.baidu = self._baidu.baidu_api
		self.baidu_v1 = self._baidu_v1.baidu_api
		...
		self._translators_dict = {
			'alibaba': self._alibaba, 'apertium': self._apertium, 'argos': self._argos, 'baidu': self._baidu,'baidu_v1': self._baidu_v1,
			'bing': self._bing,
			...
			'judic': self._judic,
			'languageWire': self._languageWire, 'lingvanex': self._lingvanex, 'niutrans': self._niutrans,
		...
		self.translators_dict = {
			'alibaba': self.alibaba, 'apertium': self.apertium, 'argos': self.argos, 'baidu': self.baidu,'baidu_v1': self.baidu_v1,
			'bing': self.bing,
	...
	def translate_text (self,
		...
		if _cache_key in self.translate_cache:
			text_res = self.translate_cache[_cache_key]
			if text_res != '':
				return text_res
		content = ''
