...
from gui.helpers.translatepy.exceptions import UnsupportedMethod
...
from gui.helpers.translatepy.translators.bing import BingSessionManager, BingExampleResult
...
class MicrosoftSessionManager():
    ...
    def send(self, url, data=None, params: Dict = {}):
