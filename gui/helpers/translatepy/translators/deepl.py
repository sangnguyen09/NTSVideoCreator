...
from gui.helpers.translatepy.translators.base import BaseTranslator, BaseTranslateException
from gui.helpers.translatepy.utils.annotations import Tuple, List
