...
class Widgets(object):
    def top_left(self, form):
        ...
        self.top_left_grip.setProperty("class", "border_none")
        # self.setProperty("class", "border_none")
    ...
    def top_right(self, form):
        ...
        self.top_right_grip.setProperty("class", "border_none")
    ...
    def bottom_left(self, form):
        ...
        self.bottom_left_grip.setProperty("class", "border_none")
    ...
    def bottom_right(self, form):
        ...
        self.bottom_right_grip.setProperty("class", "border_none")
    ...
    def top(self, form):
        ...
        self.top_grip.setProperty("class", "border_none")
    ...
    def bottom(self, form):
        ...
        self.bottom_grip.setProperty("class", "border_none")
    ...
    def left(self, form):
        ...
        self.left_grip.setProperty("class", "border_none")
    ...
    def right(self, form):
        ...
        self.right_grip.setProperty("class", "border_none")
