...
from PySide6.QtWidgets import QLabel, QFrame, QHBoxLayout, QVBoxLayout, QGroupBox, QGridLayout, QDialog, QRadioButton, \
	QTabWidget, QComboBox, QPushButton, QSpinBox

from gui.configs.config_theme import ConfigTheme
from gui.db.sqlite import CauHinhTuyChonModel
from gui.helpers.constants import SETTING_APP_DATA, LOAD_FONT_FAMILY, TOOL_CODE_MAIN, PAE_LG, CHECKOUT_DEPOSIT, \
...
class PyDialogShop(QDialog):
	...
	def create_widgets (self):
		...
		self.lb_chuc_nang = QLabel("Chức năng:")
		self.combobox_chuc_nang = QComboBox()
		
		self.lb_thoi_han = QLabel("Thời Hạn:")
		self.combobox_thoi_han = QComboBox()
		
		self.lb_slm = QLabel("Số Lượng Máy:")
		...
		self.lb_server_tts = QLabel("Server:")
		...
		self.lb_server_translate = QLabel("Server:")
		self.combobox_server_translate = QComboBox()
		
		self.lb_goi_translate = QLabel("Gói:")
	...
	def add_widgets_to_layouts (self):
		...
		self.bg_layout.addWidget(self.groupbox_thong_tin_tk)
		self.bg_layout.addWidget(self.groupbox_nap_tien)
		self.bg_layout.addWidget(self.groupbox_gia_han)
		self.bg_layout.addWidget(self.groupbox_text_to_speech)
		self.bg_layout.addWidget(self.groupbox_translate)
