...
# IMPORT QT CORE
# ///////////////////////////////////////////////////////////////
from PySide6.QtCore import Qt, QRect, QCoreApplication, QMetaObject, QSettings, Signal, QSize, QRectF, QPointF, QTimer, \
    QPoint, QObject, Slot, QByteArray, QPersistentModelIndex, QEvent
from PySide6.QtGui import QIcon, QFont, QColor, QBrush, QPen, QCursor, QTextDocument, QTextCharFormat, QTextCursor, \
    QPainter, QFontDatabase, QPixmap, QMouseEvent
from PySide6.QtWidgets import QWidget, QPushButton, QLabel, QCheckBox, \
    QLineEdit, QFrame, QHBoxLayout, QVBoxLayout, QSpinBox, QGroupBox, QGridLayout, QDialog, QColorDialog, QComboBox, \
    QSlider, QRadioButton, QFileDialog, QPlainTextEdit, QGraphicsDropShadowEffect, QSizeGrip, QApplication, QTabWidget, \
    QGraphicsRectItem, QGraphicsScene, QGraphicsItem, QMenu, QGraphicsTextItem, QGraphicsView, QGraphicsPixmapItem, \
    QGraphicsObject, QProgressBar, QTableWidgetItem, QAbstractItemView, QAbstractScrollArea, QTableWidget, QHeaderView, \
    QToolTip


# PY TITLE BUTTON
# ///////////////////////////////////////////////////////////////
class PyButtonIcon(QPushButton):
    ...
    def icon_paint(self, qp, image, rect):
        ...
        if self._is_active:
            ...
            painter.fillRect(icon.rect(), QBrush(QColor(self._icon_color_active)))
        else:

            painter.fillRect(icon.rect(),QBrush(QColor(self.set_icon_color)) )
    ...
    def move_tooltip(self):
        ...
        tooltip =QToolTip()
        tooltip.setFont(QFont('Arial', 18))
        tooltip.showText(QCursor.pos(),f'<b>{self._tooltip_text}</b>')
